			...
			<div class="w-1/2 pr-0">
				<div class="flex relative inline-block float-right">
				  ...
				  <div class="relative text-sm text-gray-100">
					  <button id="userButton" @click="userButton()" class="flex items-center focus:outline-none mr-3">
					  ...
					  <div id="userMenu" v-show="userVar" class="bg-gray-900 rounded shadow-md mt-2 absolute mt-12 top-0 right-0 min-w-full overflow-auto z-30 ">
						  <ul class="list-reset">
